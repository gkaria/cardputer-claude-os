...
| `confirm` | `{"cmd":"confirm","id":"...","title":"...","danger":true,"timeout_s":N,"details":"...","agent":"..."}` | Show a danger banner, require hold-Y-for-3 s. Send `pending` ack on receipt + resolution ack later. `details` (optional, cap `confirm_details`, ≤~320 chars) renders a scrollable action diff above the gesture. |
